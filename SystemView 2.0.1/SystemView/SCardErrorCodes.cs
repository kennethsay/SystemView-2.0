...
{
    /// <summary>
    /// All of the Smart Card Error Codes with their descriptions, this is through the Winscard DLL.
    /// Copied and Pasted all from the Internet.
    /// </summary>
    internal enum SCardErrorCodes : uint
    {
